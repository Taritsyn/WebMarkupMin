...
namespace WebMarkupMin.Sample.Resources
{
	...
	/// </summary>
	public class MinificationResources
	{
		private static Lazy<ResourceManager> _resourceManager =
			new Lazy<ResourceManager>(() => new ResourceManager(
				"WebMarkupMin.Sample.Resources.MinificationResources",
				...
				typeof(MinificationResources).GetTypeInfo().Assembly
#elif NET40
				typeof(MinificationResources).Assembly
#else
