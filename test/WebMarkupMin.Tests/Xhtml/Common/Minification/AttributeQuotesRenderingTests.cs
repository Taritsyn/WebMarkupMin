...
namespace WebMarkupMin.Tests.Xhtml.Common.Minification
{
	public class AttributeQuotesRenderingTests
	{
		...
		public void AttributeQuotesRendering()
		{
			...
			const string input2 = "<a href=\"clock.html\"><img src='clock.png' width=\"400\" height='398' " +
				"alt=\"\" /></a>";
			...
			const string targetOutput2C = "<a href='clock.html'><img src='clock.png' width='400' height='398' " +
				"alt='' /></a>";
			const string targetOutput2D = "<a href=\"clock.html\"><img src=\"clock.png\" width=\"400\" " +
				"height=\"398\" alt=\"\" /></a>";

			var autoAttributeQuoteStyleMinifier = new XhtmlMinifier(
				new XhtmlMinificationSettings(true) { AttributeQuotesStyle = HtmlAttributeQuotesStyle.Auto });
			var optimalAttributeQuoteStyleMinifier = new XhtmlMinifier(
				new XhtmlMinificationSettings(true) { AttributeQuotesStyle = HtmlAttributeQuotesStyle.Optimal });
			var singleAttributeQuoteStyleMinifier = new XhtmlMinifier(
				new XhtmlMinificationSettings(true) { AttributeQuotesStyle = HtmlAttributeQuotesStyle.Single });
			var doubleAttributeQuoteStyleMinifier = new XhtmlMinifier(
				new XhtmlMinificationSettings(true) { AttributeQuotesStyle = HtmlAttributeQuotesStyle.Double });
