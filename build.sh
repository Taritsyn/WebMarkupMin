...
if test ! -d $package_dir/Sake; then
  mono $local_nuget_package_manager install KoreBuild -Version 0.2.1-rc1-final -O $package_dir -ConfigFile $local_nuget_config_file -ExcludeVersion -NoCache -Pre
